...
const styles = StyleSheet.create({
  ...
  routeLabel: { color: colors.textPrimary, fontSize: 18, fontWeight: '700', letterSpacing: 0.5 },
  ...
  priorityBadgeText: { fontSize: 14, fontWeight: '700' },
  timesCard: {
    backgroundColor: colors.surface,
    borderRadius: 10,
    borderWidth: 1,
  ...
  timeRowValue: { fontSize: 20, fontWeight: '700', color: colors.textPrimary },
